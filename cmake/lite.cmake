...
function (lite_deps TARGET)
  set(options "")
  set(oneValueArgs "")
  set(multiValueArgs DEPS X86_DEPS CUDA_DEPS ARM_DEPS PROFILE_DEPS LIGHT_DEPS HVY_DEPS CL_DEPS FPGA_DEPS BM_DEPS NPU_DEPS XPU_DEPS CV_DEPS VK_DEPS ARGS)
...
function(lite_cc_library TARGET)
    ...
    set(oneValueArgs "")
    set(multiValueArgs SRCS DEPS X86_DEPS CUDA_DEPS CL_DEPS ARM_DEPS FPGA_DEPS BM_DEPS NPU_DEPS XPU_DEPS CV_DEPS  VK_DEPS PROFILE_DEPS LIGHT_DEPS
...
function(lite_cc_binary TARGET)
    ...
    set(oneValueArgs "")
    set(multiValueArgs SRCS DEPS X86_DEPS CUDA_DEPS CL_DEPS ARM_DEPS FPGA_DEPS BM_DEPS NPU_DEPS XPU_DEPS VK_DEPS PROFILE_DEPS
...
# device: one of (Host, ARM, X86, NPU, FPGA, OPENCL, CUDA, BM, VULKAN)
...
function(add_kernel TARGET device level)
    ...
    if ("${device}" STREQUAL "VULKAN")
        if (NOT LITE_WITH_VULKAN)
            return()
        endif()
        set(vulkan_kernels "${vulkan_kernels};${TARGET}" CACHE INTERNAL "")
    endif()
