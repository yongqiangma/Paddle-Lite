...
message(STATUS "----------000i00--------------------------- ${CUDA_CUBLAS_LIBRARIES}")
message(STATUS "----------00i000--------------------------- ")
    get_property(os_dependency_modules GLOBAL PROPERTY OS_DEPENDENCY_MODULES)
    target_link_libraries(${TARGET_NAME} ${nv_test_DEPS} lite_gtest_main gtest
gflags glog ${os_dependency_modules} ${CUDNN_LIBRARY} ${CUDA_CUBLAS_LIBRARIES1} )
    message(STATUS "---------------------------------------- ${CUDNN_LIBRARY}")
    message(STATUS "------------TARGET_NAME---------------------------- ${TARGET_NAME}")
    message(STATUS "------------------------------------- ${CUDA_CUBLAS_LIBRARIES}")
    message(STATUS "------------------------------------- ${CUDA_CUBLAS_LIBRARIES1}")
