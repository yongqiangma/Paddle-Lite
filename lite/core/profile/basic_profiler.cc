...
#include <string>
  ...
  std::string FLAGS_time_profile_file = "time_profile.txt";
  std::string FLAGS_time_profile_summary_file = "time_profile_summary.txt";
  std::string FLAGS_time_profile_unit = "ms";
#else
